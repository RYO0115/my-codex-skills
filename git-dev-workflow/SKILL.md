...
**PR は、ユーザーから draft の明示指定がない限り、最初から Ready for review で提出する。**
使用するツールや連携機能が draft を既定値にしていても、その既定値には従わない。
作業が未完成であることを共有するPRや、ユーザーが draft を依頼した場合だけ draft にする。
...
- [ ] PR 本文に上記 6 項目を記載した
- [ ] ユーザーから draft の指定がなければ Ready for review でPRを提出した
